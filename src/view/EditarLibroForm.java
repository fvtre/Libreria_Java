...
public class EditarLibroForm extends javax.swing.JFrame {
     ...
     */
    public EditarLibroForm(Libro libro) {
        initComponents();
        daoLibro = new DaoLibro();
        
        this.libro = libro;
        
        /*libro seleccionado para autocompletar los txt*/
        txtTitulo.setText(this.libro.getTitulo());
        txtIsbn.setText(this.libro.getIsbn());
        txtPaginas.setText(String.valueOf(this.libro.getPaginas()));
        txtPrecio.setText(String.valueOf(this.libro.getPrecio()));
        txtAnio.setText(String.valueOf(this.libro.getAnio()));
        txtGenero.setText(this.libro.getGenero());
    ...
    private void initComponents() {
        ...
        btnEditarLibro.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        btnEditarLibro.setText("Guardar");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnEditarLibro, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnEditarLibroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarLibroActionPerformed
        ...
        if(daoLibro.editar(libro)==1){
            showMessageDialog(null, "Correctamente editado");
