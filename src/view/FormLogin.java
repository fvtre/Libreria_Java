...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextUser.setBackground(new java.awt.Color(0, 204, 204));
    ...
    private void btnEntryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntryActionPerformed
        ...
        String contrasena = new String(jTextPass.getPassword());
        
        User user = new User();
        Cuenta cuenta = user.acceder(usuario, contrasena);

        
        if (cuenta != null) {
            showMessageDialog(null,  "Inicio de sesión exitoso");
            ...
            showMessageDialog(null, "Inicio de sesión fallido. Verifica tus credenciales.");
        }
